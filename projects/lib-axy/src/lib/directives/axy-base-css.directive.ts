...
export class AxyBaseCssDirective implements OnInit {
  ...
  ngOnInit() {
    ...
    s.textContent = `
      ...
      html,body{ margin:0; font-family: ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, Inter, "Noto Sans", "Helvetica Neue", Arial, "Apple Color Emoji", "Segoe UI Emoji"; background:  #79d0ffff; color: var(--ui-text); }
    `;
